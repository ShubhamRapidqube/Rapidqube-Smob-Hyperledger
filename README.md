...
II. Goto "./fabcar" perform "./startFabric.sh javascript" command in cmd.


III. Copy the wallet folder from path "./fabcar/javascript" & paste it in folder "./smob".


IV. Finally to run the project goto "./smob" and perform "node index" in cmd. 
